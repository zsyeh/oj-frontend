<template>
    <div class="user-info">
      <el-tabs v-model="activeTab" type="card">
        ...
        <el-tab-pane label="信息反馈" name="feedback">
          <el-card>
            <h2>联系我们&意见反馈</h2>
            <el-form :model="passwordForm" label-width="120px">
              <el-form-item :rules="[ { required: true, message: '请输入反馈信息', trigger: 'blur' } ]">
                <el-input v-model="passwordForm.currentPassword" type="text" placeholder="请输入反馈信息" />
              </el-form-item>
  
              <el-form-item>
                <el-button type="primary" @click="commit-feedback">提交</el-button>
              </el-form-item>
            </el-form>
          </el-card>
        </el-tab-pane>
